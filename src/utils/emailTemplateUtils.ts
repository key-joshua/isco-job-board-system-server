...
export const verifyAccountTemplate = (receiverEmail: string, action: string, url: string): SendMailOptions => {
    return {
        to: receiverEmail,
        subject: `ISCO JOB BOARD SYSTEM ${action}`,
        from: `ISCO JOB BOARD SYSTEM <${process.env.SMTP_GMAIL_SENDER_EMAIL}>`,
        text: 'Hello From ISCO JOB BOARD SYSTEM, We received a request to verify your account.',
                ...
                <table style="max-width: 700px; width: 100%; background-color: #ffffff; border-radius: 16px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); overflow: hidden;">
                        ...
                        <td style="background: #082777; padding: 30px 40px; text-align: center;">
                            <div style="display: inline-flex; align-items: center; gap: 8px;">
                                <div style="width: 30px; height: 30px; margin-right: 20px; border-radius: 4px; position: relative;">
                                    <img src="https://res.cloudinary.com/donuwgeyj/image/upload/v1755160170/logo_p1pahh.png" alt="ISCO JOB BOARD SYSTEM Logo" style="width: 30px; height: 30px;" />
                                </div>
                                <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: 600;">ISCO JOB BOARD SYSTEM</h1>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="color: #5a6c7d; font-size: 16px; line-height: 1.6; margin: 0 0 25px 0; text-align: center;">
                                Welcome to ISCO JOB BOARD SYSTEM! We're excited to have you join our platform. To complete your registration and access all features, please verify your email address.
                            </p>
                            ...
                            <div style="border-left: 4px solid #4a90e2; padding-left: 16px; margin: 30px 0;">
                                <p style="color: #5a6c7d; font-size: 14px; margin: 0; line-height: 1.5;">
                                    <strong>Security Note:</strong> This verification link will expire in 24 hours for your security. If you didn't create an account with ISCO JOB BOARD SYSTEM, please ignore this email.
                                </p>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f8fafc; padding: 10px 40px; text-align: center; border-top: 1px solid #e2e8f0;">
                            ...
                            <p style="color: #cbd5e1; font-size: 12px; margin: 0;"> © 2024 ISCO JOB BOARD SYSTEM. All rights reserved. </p>
                        </td>
                    </tr>
                </table>
            </td>
...
export const resetPasswordTemplate = (receiverEmail: string, action: string, url: string): SendMailOptions => {
    return {
        ...
        subject: `ISCO JOB BOARD SYSTEM ${action}`,
        from: `ISCO JOB BOARD SYSTEM <${process.env.SMTP_GMAIL_SENDER_EMAIL}>`,
        text: 'Hello from ISCO JOB BOARD SYSTEM. We received a request to reset your password.',
        html: `<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: linear-gradient(135deg, #e8f4fd 0%, #d6e9f7 100%); min-height: 100vh;">
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <table style="max-width: 700px; width: 100%; background-color: #ffffff; border-radius: 16px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="color: #5a6c7d; font-size: 16px; line-height: 1.6; margin: 0 0 25px 0; text-align: center;">
                                We received a request to reset the password for your ISCO JOB BOARD SYSTEM account. Click the button below to set a new password for your account.
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #f8fafc; padding: 10px 40px; text-align: center; border-top: 1px solid #e2e8f0;">
                            ...
                            <p style="color: #cbd5e1; font-size: 12px; margin: 0;">
                                © 2024 ISCO JOB BOARD SYSTEM. All rights reserved.
                            </p>
                        </td>
                    </tr>
                </table>
